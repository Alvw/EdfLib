...
/**
 * The simplest realisation of Moving Average Filter that buffer given number (n) of incoming
 * samples and return its average value
 *
 * <p>filteredValue_m = ( value_m + value_(m-1) + ... + value_(m-n) ) / n
 */
...
public class SignalMovingAverageFilter implements SignalFilter{
    ...
    /**
     * Calculate the average value of  last n samples, where n = numberOfAveragingPoints
