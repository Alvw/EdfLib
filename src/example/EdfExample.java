    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (edfFileReader.availableSamples(0) > 0) {
                fileWriter2.writeDigitalSamples(edfFileReader.readDigitalSamples(0, headerConfig.getNumberOfSamplesInEachDataRecord(0)));
                fileWriter2.writeDigitalSamples(edfFileReader.readDigitalSamples(1, headerConfig.getNumberOfSamplesInEachDataRecord(1)));
            }
            fileWriter2.close();
